        ...
        try {
            ...
            if (user instanceof Student) {
                ...
                if (fullName != null && !fullName.isEmpty()) {
                    String rawFirstName = fullName.split(" ")[0];

                    // Capitalize first letter, force the rest to lowercase
                    String firstName = rawFirstName.substring(0, 1).toUpperCase() +
                            rawFirstName.substring(1).toLowerCase();
